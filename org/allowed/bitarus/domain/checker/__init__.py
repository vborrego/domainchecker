...
class Domain(object):
    ...
    '''
    def __init__(self, domain, status, expirationDate):
        self.exception = ''
...
class Checker(object):    
    def __init__(self):
        ...
        for domain in config.getDomains():
            ...
            domainStatus.append(Domain(whoisRes.domain_name, whoisRes.status ,whoisRes.expiration_date))
